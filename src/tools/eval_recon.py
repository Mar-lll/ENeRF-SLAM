...
def completion_ratio(gt_points, rec_points, dist_th=5.5):
...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=True):
    ...
    accuracy_rec = accuracy(gt_pc_tri.vertices, rec_pc_tri.vertices*10)
    completion_rec = completion(gt_pc_tri.vertices, rec_pc_tri.vertices*10)
    completion_ratio_rec = completion_ratio(
        gt_pc_tri.vertices, rec_pc_tri.vertices*10)
